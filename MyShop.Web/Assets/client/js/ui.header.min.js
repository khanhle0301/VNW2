...
//function includeJS(a) {
//    document.write('<script type="text/javascript" src="' + base_url + "js/" + a + '">\x3c/script>')
//}
//includeJS("placeholders_autoinit.js");
//includeJS("jqueryUiQuickSearchBlock.js");
//includeJS("quickSearchBlock.min.js");
//includeJS("master.js");
...
//}); //# sourceMappingURL=ui.header.min.js.map
...
$(function () {
    ...
    var a = $(".alert-notifications .number");
    $(".alert-notifications").popover({
        ...
        setLocalStorage("number_isviewed", !0);
        a.hide();
        b.stopPropagation()
    });
    var b = document.getElementById("activate"),
        b = null == b || 1 != b.value,
        c = getLocalStorage("number_isviewed");
    b && c ? a.hide() : a.show();
